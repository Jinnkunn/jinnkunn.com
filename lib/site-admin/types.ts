export type SiteSettings = {
  ...
  memorialScope: "home" | "all-public";
  memorialEyebrow: string;
  memorialTitle: string;
  memorialContext: string;
  memorialEnglishTitle: string;
  memorialMessage: string;
  memorialChineseTitle: string;
  memorialChineseMessage: string;
  memorialSourceLabel: string;
  memorialSourceUrl: string;
  memorialSourceChineseLabel: string;
  memorialSourceChineseUrl: string;
  memorialStartsAt: string;
  memorialEndsAt: string;
