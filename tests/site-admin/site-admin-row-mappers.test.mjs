...
test("site-admin-row-mappers: mapSiteSettingsRow maps fields + defaults", () => {
  const row = {
    ...
    properties: {
      ...
      "OG Image": rich("/assets/profile.png"),
      "SEO Page Overrides": rich('{"/blog": {"title": "Blog"}}'),
      "Google Analytics ID": rich("G-XXXX"),
      "Content GitHub Users": rich("alice,bob"),
      "Monochrome Enabled": checkbox(true),
      "Monochrome Scope": rich("home"),
      "Monochrome Desaturate Media": checkbox(false),
      "Monochrome Starts At": rich("2026-08-29"),
      "Monochrome Ends At": rich("2026-08-31"),
  ...
  assert.deepEqual(actual, {
    ...
    seoPageOverrides: '{"/blog": {"title": "Blog"}}',
    googleAnalyticsId: "G-XXXX",
    contentGithubUsers: "alice,bob",
    monochromeEnabled: true,
    monochromeScope: "home",
    monochromeDesaturateMedia: false,
    monochromeStartsAt: "2026-08-29",
    monochromeEndsAt: "2026-08-31",
    sitemapExcludes: "/private\n/bio",
    sitemapAutoExcludeEnabled: false,
    sitemapAutoExcludeSections: "blog, teaching",
    sitemapAutoExcludeDepthPages: "2",
    sitemapAutoExcludeDepthBlog: "3",
    sitemapAutoExcludeDepthPublications: "4",
