...
export function defaultSettings(): SiteSettings {
  return {
    ...
    monochromeScope: "all-public",
    monochromeDesaturateMedia: true,
    monochromeStartsAt: "",
    monochromeEndsAt: "",
    sitemapExcludes: "",
...
export function normalizeSettings(input: unknown): SiteSettings {
  ...
  return {
    ...
    monochromeEnabled: Boolean(src.monochromeEnabled),
    monochromeScope: src.monochromeScope === "home" ? "home" : "all-public",
    monochromeDesaturateMedia: Boolean(src.monochromeDesaturateMedia ?? true),
    monochromeStartsAt: normalizeString(src.monochromeStartsAt),
    monochromeEndsAt: normalizeString(src.monochromeEndsAt),
