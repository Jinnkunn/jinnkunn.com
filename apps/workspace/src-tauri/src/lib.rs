...
pub fn run() {
    ...
    let builder = desktop_shell::install_desktop_shell_plugins(builder)
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            site_admin::site_admin_start_release_job,
            site_admin::site_admin_start_rollback_job,
            ...
            local_db::workspace_backup_info,
            local_db::workspace_backup_create,
            local_db::workspace_backup_restore,
            local_db::workspace_backup_auto,
            local_db::workspace_backup_preview,
            local_db::workspace_backups_list,
            ...
            mcp::workspace_mcp_content_publish_suggestion_get,
            mcp::workspace_mcp_content_publish_suggestion_clear,
