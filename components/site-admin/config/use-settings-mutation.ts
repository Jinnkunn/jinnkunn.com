  ...
  return async () => {
    ...
    try {
      const patch: Partial<Omit<SiteSettings, "rowId">> = {
        ...
        memorialEnabled: draftSettings.memorialEnabled,
        memorialScope: draftSettings.memorialScope,
        memorialEyebrow: draftSettings.memorialEyebrow,
        memorialTitle: draftSettings.memorialTitle,
        memorialContext: draftSettings.memorialContext,
        memorialEnglishTitle: draftSettings.memorialEnglishTitle,
        memorialMessage: draftSettings.memorialMessage,
        memorialChineseTitle: draftSettings.memorialChineseTitle,
        memorialChineseMessage: draftSettings.memorialChineseMessage,
        memorialSourceLabel: draftSettings.memorialSourceLabel,
        memorialSourceUrl: draftSettings.memorialSourceUrl,
        memorialSourceChineseLabel: draftSettings.memorialSourceChineseLabel,
        memorialSourceChineseUrl: draftSettings.memorialSourceChineseUrl,
        memorialStartsAt: draftSettings.memorialStartsAt,
        memorialEndsAt: draftSettings.memorialEndsAt,
