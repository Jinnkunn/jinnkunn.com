...
function PageIcon() {
  // Match the small "page" icon used by Notion list items.
  return (
    <svg
...
export default async function BlogPage() {
  ...
  return (
    <main id="page-blog" className="super-content page__blog parent-page__index">
      ...
      <article id="block-blog" className="notion-root max-width has-footer">
        <p className="notion-text notion-text__content notion-semantic-string">
          <span className="highlighted-color color-default">
            <span className="highlighted-background bg-yellow">
              <strong>
                <a href="/blog.rss" className="notion-link link">
                  RSS Feed
                </a>
              </strong>
            </span>
                ...
                <div className="notion-collection-list__item-content">
                  {p.dateText ? (
                    <div className="notion-property notion-property__date notion-collection-list__item-property notion-semantic-string no-wrap">
                      <span className="date">{p.dateText}</span>
                    </div>
                  ) : null}
                </div>
              </div>
